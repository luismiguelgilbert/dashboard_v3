...
export const bitacora_cars_form_schema = bitacora_cars_schema.extend({
  is_active: z.coerce.boolean(),
  disabled: z.coerce.boolean().optional(),
  created_at: z.string().optional().nullable(),
  updated_at: z.string().optional().nullable(),
}).strict();
export type bitacora_cars_form = z.infer<typeof bitacora_cars_form_schema>

export const bitacora_cars_sort_enum = z.enum(['a.name_es', 'a.name_es_short', 'a.is_active']);
export type bitacora_cars_sort_enum = z.infer<typeof bitacora_cars_sort_enum>;

export const bitacora_cars_sort_options_schema = z.object({
  value: bitacora_cars_sort_enum,
  label: z.string(),
});
export type bitacora_cars_sort_options = z.infer<typeof bitacora_cars_sort_options_schema>
...
export const bitacora_cars_query_schema = z.object({
  ...
  sortBy: bitacora_cars_sort_enum,
}).strict();
export type sys_companies_query = z.infer<typeof bitacora_cars_query_schema>

export const bitacora_cars_query_download_schema = z.object({
  searchString: z.string()
    .refine(s => !s.includes(' '), 'Sin espacios!')
    .refine(s => !s.includes(';'), 'Sin caracteres especiales!')
    .refine(s => !s.includes('truncate'), 'Sin palabras claves!')
