...
<template>
  <UForm
    ...
    :schema="bitacora_places_form_schema"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-1 sm:gap-5 px-1 sm:px-4 items-end">
      ...
      <div class="self-start">
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Nombre clave del punto de control.
        </p>
      </div>
      <UFormGroup
        :size="inputSize"
      ...
      <div class="self-start">
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Nombre descriptivo del punto de control.
        </p>
      </div>
      <UFormGroup
        :size="inputSize"
      ...
      <div class="self-start">
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Foto del punto de control (1MB max).
        </p>
      </div>
      <UFormGroup
        :size="inputSize"
