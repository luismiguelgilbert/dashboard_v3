...
export const bitacora_places_options_schema = z.object({
  value: bitacora_places_sort_enum,
  label: z.string(),
});
export type bitacora_places_options = z.infer<typeof bitacora_places_options_schema>
